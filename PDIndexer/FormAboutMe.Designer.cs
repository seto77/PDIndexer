...
namespace PDIndexer
{
    ...
    partial class FormAboutMe : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 260531Cl 追加: リンクラベル配線(文案は resx/ja.resx)
            this.toolTip.SetToolTip(this.linkLabelMail, resources.GetString("linkLabelMail.ToolTip"));
            this.toolTip.SetToolTip(this.linkLabelHomePage, resources.GetString("linkLabelHomePage.ToolTip"));
