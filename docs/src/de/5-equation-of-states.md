...
![Vollständiges Fenster der Zustandsgleichungen](../assets/cap-de-auto/FormEOS.png)
...
![Liste der Zustandsgleichungs-Quellen für Gold](../assets/cap-de-auto/FormEOS.tableLayoutPanel1.flowLayoutPanel1.groupBoxGold.png)
...
![Liste der Zustandsgleichungs-Quellen für NaCl-B1](../assets/cap-de-auto/FormEOS.tableLayoutPanel1.flowLayoutPanel1.groupBoxNaClB1.png)

Für `NaCl (B1)` stehen Zustandsgleichungen wie `Brown (99)`, `Sakai+` und `Matsui (12)` zur Verfügung.

### Periklas (MgO)

![Liste der Zustandsgleichungs-Quellen für Periklas MgO](../assets/cap-de-auto/FormEOS.tableLayoutPanel1.flowLayoutPanel1.groupBoxPericlase.png)
...
| Quelle | Modell | Hauptparameter |
| --- | --- | --- |
| Sata02 (Pt-Skala) | geschlossene Decker/Sata-Form | Pr=31.14, Kr=143.5, V0=27.17 Å³ |
| Sata02 (MgO-Skala) | geschlossene Decker/Sata-Form | Pr=32.15, Kr=141.0, V0=27.17 Å³ |
| Ueda08 | Vinet + linearer thermischer Term | K0=28.45, K0'=5.16; thermisch 0.00468(T−300) |
| Sakai11 BM | BM3 (isotherm) | K0=47.00, K0'=4.10, V0=37.73 Å³ |
| Sakai11 Vinet | Vinet (isotherm) | K0=40.40, K0'=5.04, V0=37.73 Å³ |
...
| Anz | Vinet (isotherm) | K0=352.6, K0'=4.56, V0=29.467 Å³ |
| Sakai | Vinet (isotherm) | K0=358, K0'=4.8, V0=29.47 Å³ |
| Dub | BM4 (isotherm) | K0=342, K0'=6.15, K0''=−0.029, V0=29.46 Å³ |
