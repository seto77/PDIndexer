...
![狀態方程視窗全貌](../assets/cap-zh-Hant-auto/FormEOS.png)
...
![金的狀態方程出處清單](../assets/cap-zh-Hant-auto/FormEOS.tableLayoutPanel1.flowLayoutPanel1.groupBoxGold.png)

對於金（`Au (Gold)`），可使用 `Yokoo (09)`、`Matsui (09)`、`Holmes (89)`、`Jamieson (82)`、`Fratanduono (21)` 等狀態方程。

### NaCl（B1 結構）

![NaCl-B1 的狀態方程出處清單](../assets/cap-zh-Hant-auto/FormEOS.tableLayoutPanel1.flowLayoutPanel1.groupBoxNaClB1.png)

對於 `NaCl (B1)`，可使用 `Brown (99)`、`Sakai+`、`Matsui (12)` 等狀態方程。

### 方鎂石（MgO）

![方鎂石 MgO 的狀態方程出處清單](../assets/cap-zh-Hant-auto/FormEOS.tableLayoutPanel1.flowLayoutPanel1.groupBoxPericlase.png)
...
| 出處 | 模型 | 主要參數 |
| --- | --- | --- |
| Sata02（Pt 基準） | Decker/Sata 閉合式 | Pr=31.14, Kr=143.5, V0=27.17 Å³ |
| Sata02（MgO 基準） | Decker/Sata 閉合式 | Pr=32.15, Kr=141.0, V0=27.17 Å³ |
| Ueda08 | Vinet + 線性熱項 | K0=28.45, K0'=5.16；熱項 0.00468(T−300) |
| Sakai11 BM | BM3（等溫） | K0=47.00, K0'=4.10, V0=37.73 Å³ |
| Sakai11 Vinet | Vinet（等溫） | K0=40.40, K0'=5.04, V0=37.73 Å³ |
...
| Anz | Vinet（等溫） | K0=352.6, K0'=4.56, V0=29.467 Å³ |
| Sakai | Vinet（等溫） | K0=358, K0'=4.8, V0=29.47 Å³ |
| Dub | BM4（等溫） | K0=342, K0'=6.15, K0''=−0.029, V0=29.46 Å³ |
