...
![Ventana completa de Ecuaciones de estado](../assets/cap-es-auto/FormEOS.png)
...
![Lista de referencias de ecuaciones de estado para el oro](../assets/cap-es-auto/FormEOS.tableLayoutPanel1.flowLayoutPanel1.groupBoxGold.png)
...
![Lista de referencias de ecuaciones de estado para NaCl-B1](../assets/cap-es-auto/FormEOS.tableLayoutPanel1.flowLayoutPanel1.groupBoxNaClB1.png)

Para `NaCl (B1)` están disponibles ecuaciones de estado como `Brown (99)`, `Sakai+` y `Matsui (12)`.

### Periclasa (MgO)

![Lista de referencias de ecuaciones de estado para la periclasa MgO](../assets/cap-es-auto/FormEOS.tableLayoutPanel1.flowLayoutPanel1.groupBoxPericlase.png)
...
| Fuente | Modelo | Parámetros principales |
| --- | --- | --- |
| Sata02 (escala Pt) | forma cerrada de Decker/Sata | Pr=31.14, Kr=143.5, V0=27.17 Å³ |
| Sata02 (escala MgO) | forma cerrada de Decker/Sata | Pr=32.15, Kr=141.0, V0=27.17 Å³ |
| Ueda08 | Vinet + término térmico lineal | K0=28.45, K0'=5.16; térmico 0.00468(T−300) |
| Sakai11 BM | BM3 (isotérmica) | K0=47.00, K0'=4.10, V0=37.73 Å³ |
| Sakai11 Vinet | Vinet (isotérmica) | K0=40.40, K0'=5.04, V0=37.73 Å³ |
...
| Anz | Vinet (isotérmica) | K0=352.6, K0'=4.56, V0=29.467 Å³ |
| Sakai | Vinet (isotérmica) | K0=358, K0'=4.8, V0=29.47 Å³ |
| Dub | BM4 (isotérmica) | K0=342, K0'=6.15, K0''=−0.029, V0=29.46 Å³ |
