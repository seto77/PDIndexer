...
!!! note
    Если атомные позиции не введены, интенсивности не вычисляются независимо от состояния флажка. О вводе атомных данных см. [вкладку Atom Info.](#atom-info-tab).
...
| Вкладка | Содержимое |
| --- | --- |
| `Basic Info.` | Параметры решётки, сингония, пространственная группа и другая базовая информация |
| `Atom Info.` | Типы атомов, заселённость, координаты и температурные факторы |
...
### Вкладка Atom Info. {#atom-info-tab}

![Вкладка Atom Info.](../assets/cap-ru-auto/FormCrystal.splitContainer1.groupBox3.crystalControl.tabControl.tabPageAtom.png)
