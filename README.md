...
* PDIndexer runs on Windows OS with .Net Desktop Runtime 10.0 (not .Net Runtime 10.0), which can be installed from [here](https://dotnet.microsoft.com/ja-jp/download/dotnet/10.0).
